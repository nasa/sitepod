...
function getSettings() {
	...
	$SETTINGS[PSNG_SITEMAP_URL] = $SETTINGS[PSNG_WEBSITE] . basename($SETTINGS[PSNG_SITEMAP_FILE]);
    $SETTINGS[PSNG_TXTSITEMAP_URL] = $SETTINGS[PSNG_WEBSITE] . basename($SETTINGS[PSNG_TXTSITEMAP_FILE]);
